...
import {faPhone,faMap,faPhotoVideo} from "@fortawesome/free-solid-svg-icons";
                    ...
                    <div className='colored-social'>
                        {
                            footerTexts.socialItem.map((item)=>{
                                return(
                                    <MobileView><li className="footer-item"><span>
                                    <FontAwesomeIcon icon={item.socialIcon}/>{item.text}</span></li></MobileView>
                                )
                            })
                        }
                    </div>
                ...
                <ul className="footer-item-container">
                    {
                        footerTexts.socialItem.map((item)=>{
                            return(
                                <li className="footer-item"><span><FontAwesomeIcon icon={item.socialIcon}/> {item.text}</span></li>
                            )
                        })
                    }
                </ul>
