    ...
    return (
        <div className='title-section'>
            ...
            <div className='star-container'>
                <div className='stars'>{stars.map(() => { return (<FontAwesomeIcon icon={faStar} />) })} ___  0 نظر</div>
                <BrowserView><div><button className='submit-btn'>ارسال آنی</button></div></BrowserView>
            </div>
            <button className='price-container-btn'>
                <div className='shopping-icon'><FontAwesomeIcon icon={faShoppingBag} /></div>
                <div>
                    <div className='new-price-container'><span>خرید</span><span className='price-num'>{data.newprice}</span><span>تومان</span></div>
                    <div className='old-price-container'><span className='discount-percent'> {discountPercent}% تخفیف </span><span className='old-price'>{data.price}تومان</span></div>
                </div>
            </button>
